-- C&C CRM Database Migration Script
-- Upgrades existing schema to optimized version with enhanced performance
-- Preserves all existing data while adding new features and indexes
...
-- JourneyStep indexes
CREATE INDEX IF NOT EXISTS "JourneyStep_journeyId_stepNumber_idx" ON "JourneyStep"("journeyId", "stepNumber");
CREATE INDEX IF NOT EXISTS "JourneyStep_status_startedAt_idx" ON "JourneyStep"("status", "startedAt");
CREATE INDEX IF NOT EXISTS "JourneyStep_approvedBy_approvedAt_idx" ON "JourneyStep"("approvedBy", "approvedAt");

-- StepActivity indexes
CREATE INDEX IF NOT EXISTS "StepActivity_stepId_activityType_idx" ON "StepActivity"("stepId", "activityType");
CREATE INDEX IF NOT EXISTS "StepActivity_createdBy_createdAt_idx" ON "StepActivity"("createdBy", "createdAt");
CREATE INDEX IF NOT EXISTS "StepActivity_status_createdAt_idx" ON "StepActivity"("status", "createdAt");

-- AssignedCrew indexes
CREATE INDEX IF NOT EXISTS "AssignedCrew_journeyId_role_idx" ON "AssignedCrew"("journeyId", "role");
CREATE INDEX IF NOT EXISTS "AssignedCrew_userId_status_idx" ON "AssignedCrew"("userId", "status");
CREATE INDEX IF NOT EXISTS "AssignedCrew_assignedAt_idx" ON "AssignedCrew"("assignedAt");

-- JourneyEntry indexes
CREATE INDEX IF NOT EXISTS "JourneyEntry_journeyId_type_idx" ON "JourneyEntry"("journeyId", "type");
CREATE INDEX IF NOT EXISTS "JourneyEntry_createdBy_timestamp_idx" ON "JourneyEntry"("createdBy", "timestamp");
CREATE INDEX IF NOT EXISTS "JourneyEntry_tag_timestamp_idx" ON "JourneyEntry"("tag", "timestamp");
CREATE INDEX IF NOT EXISTS "JourneyEntry_priority_timestamp_idx" ON "JourneyEntry"("priority", "timestamp");

-- Media indexes
CREATE INDEX IF NOT EXISTS "Media_journeyId_type_idx" ON "Media"("journeyId", "type");
CREATE INDEX IF NOT EXISTS "Media_uploadedBy_createdAt_idx" ON "Media"("uploadedBy", "createdAt");
CREATE INDEX IF NOT EXISTS "Media_size_idx" ON "Media"("size");
CREATE INDEX IF NOT EXISTS "Media_tags_idx" ON "Media" USING GIN("tags");

-- AuditEntry indexes
CREATE INDEX IF NOT EXISTS "AuditEntry_clientId_timestamp_idx" ON "AuditEntry"("clientId", "timestamp");
CREATE INDEX IF NOT EXISTS "AuditEntry_locationId_timestamp_idx" ON "AuditEntry"("locationId", "timestamp");
CREATE INDEX IF NOT EXISTS "AuditEntry_userId_timestamp_idx" ON "AuditEntry"("userId", "timestamp");
CREATE INDEX IF NOT EXISTS "AuditEntry_entity_entityId_idx" ON "AuditEntry"("entity", "entityId");
CREATE INDEX IF NOT EXISTS "AuditEntry_severity_timestamp_idx" ON "AuditEntry"("severity", "timestamp");
CREATE INDEX IF NOT EXISTS "AuditEntry_action_timestamp_idx" ON "AuditEntry"("action", "timestamp");

-- MoveSource indexes
CREATE INDEX IF NOT EXISTS "MoveSource_clientId_status_idx" ON "MoveSource"("clientId", "status");
CREATE INDEX IF NOT EXISTS "MoveSource_externalId_idx" ON "MoveSource"("externalId");
CREATE INDEX IF NOT EXISTS "MoveSource_status_isActive_idx" ON "MoveSource"("status", "isActive");
...
-- JourneyStep unique constraints
CREATE UNIQUE INDEX IF NOT EXISTS "JourneyStep_journeyId_stepNumber_key" ON "JourneyStep"("journeyId", "stepNumber");

-- AssignedCrew unique constraints
CREATE UNIQUE INDEX IF NOT EXISTS "AssignedCrew_journeyId_userId_key" ON "AssignedCrew"("journeyId", "userId");

-- MoveSource unique constraints
CREATE UNIQUE INDEX IF NOT EXISTS "MoveSource_clientId_name_key" ON "MoveSource"("clientId", "name");
...
INSERT INTO "AuditEntry" (
    ...
    'DATABASE',
    'schema_optimized',
    '{"version": "2.6.0", "migration": "schema_optimized", "timestamp": "' || CURRENT_TIMESTAMP || '"}',
    'INFO'
); 